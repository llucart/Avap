...
if(!empty($_POST)){
	$usuario->editUsuario($_POST['id_usuario'], $_POST['cuenta'], $_POST['clave'], $_POST['rol']);
	...
	<div class="form-group" id="formLogin">
		<form class="form-group" action="" method="post">
			...
			<div class="form-group">
				<input type="text" class="form-control" required value="<?php echo $rs['cuenta']; ?>" name="cuenta">
			</div>
			<div class="form-group">
				<select name="rol" id="rol" class="form-control" required>
					<option value="">Selecciona un nuevo rol "<?php echo $rs['rol']; ?>"</option>
			...
			<div class="form-group">
				<input type="password" class="form-control" required name="clave" placeholder="Colocar nueva clave">
			</div>
